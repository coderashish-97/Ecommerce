...
class Customer(models.Model):
    ...
    phone_field = models.CharField(max_length=10, null=True)
...
class Order(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.order_id is None and self.ordered_date and self.id:
            self.order_id = self.ordered_date.strftime('PAY2ME%Y%m%dODR') + str(self.id)
